...
import PatternMakingTab from './components/PatternMakingTab';
import { initialTechPack, TechPackData } from './types';
import { Ruler, Image as ImageIcon, Tags, Printer, Menu, X, Save, FileText, Scissors, Droplet, Compass, Layers, Palette, Columns, Calculator, View, Sparkles } from 'lucide-react';

type TabId = 'overview' | 'images' | 'print' | 'print-sketch' | 'mockup' | 'colorways' | '3d-preview' | 'virtual-tryon' | 'pattern-making' | 'construction' | 'trims' | 'bom' | 'measurements' | 'guide' | 'costing' | 'export';

export default function App() {
  const [activeTab, setActiveTab] = useState<TabId>('virtual-tryon');
  ...
  const tabs = [
    { id: 'virtual-tryon', name: 'AI Virtual Try-On', icon: Sparkles },
